...
void OperacionesArreglos::crearArregloMPI(
    ...
    for (int i = 0; i < cantidad; i++) {
        ...
        if (aleatorio) {
// Se genera un valor diferente utilizando la posicion,
// el proceso y el hilo como parte de la formula.
// El resultado siempre queda entre 1 y 1,000,000.
